...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "TheFitNation@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "TheFitNation API";

        private String description = "TheFitNation API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "TheFitNation";
