...
public class WorkoutInstanceResource {
    ...
    public ResponseEntity<List<WorkoutInstance>> getAllWorkoutInstances(@ApiParam Pageable pageable)
        ...
        Page<WorkoutInstance> page = workoutInstanceRepository.findAll(pageable);
    ...
    public ResponseEntity<List<WorkoutInstance>> searchWorkoutInstances(@RequestParam String query, @ApiParam Pageable pageable)
        ...
        Page<WorkoutInstance> page = workoutInstanceSearchRepository.search(queryStringQuery(query), pageable);
