...
public class WorkoutLogResource {
    ...
    @Timed
    public ResponseEntity<List<WorkoutLog>> getAllWorkoutLogs(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of WorkoutLogs");
        Page<WorkoutLog> page = workoutLogRepository.findAll(pageable);
    ...
    public ResponseEntity<List<WorkoutLog>> searchWorkoutLogs(@RequestParam String query, @ApiParam Pageable pageable)
        ...
        Page<WorkoutLog> page = workoutLogSearchRepository.search(queryStringQuery(query), pageable);
