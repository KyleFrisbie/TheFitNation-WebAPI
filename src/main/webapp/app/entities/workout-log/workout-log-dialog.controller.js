(function() {
    ...
    WorkoutLogDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'WorkoutLog', 'WorkoutTemplate', 'WorkoutInstance'];

    function WorkoutLogDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, WorkoutLog, WorkoutTemplate, WorkoutInstance) {
        var vm = this;
