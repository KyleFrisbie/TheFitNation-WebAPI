...
@Transactional
public class WorkoutTemplateRepositoryIntTest {
    ...
    public void findOne() {
        ...
        WorkoutTemplate savedWorkoutTemplate = workoutTemplateRepository.findOne(user.getLogin(), workoutTemplate.getId());
