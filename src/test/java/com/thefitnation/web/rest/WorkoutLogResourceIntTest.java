...
public class WorkoutLogResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(workoutLogResource, "workoutLogSearchRepository", workoutLogSearchRepository);
        ReflectionTestUtils.setField(workoutLogResource, "workoutLogRepository", workoutLogRepository);
    ...
    public void updateWorkoutLog() throws Exception {
        // Initialize the database
        workoutLogRepository.saveAndFlush(workoutLog);
        workoutLogSearchRepository.save(workoutLog);
