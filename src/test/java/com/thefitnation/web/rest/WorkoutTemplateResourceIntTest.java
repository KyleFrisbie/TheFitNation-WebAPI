...
public class WorkoutTemplateResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(workoutTemplateResource, "workoutTemplateSearchRepository", workoutTemplateSearchRepository);
        ReflectionTestUtils.setField(workoutTemplateResource, "workoutTemplateRepository", workoutTemplateRepository);
    ...
    public void updateWorkoutTemplate() throws Exception {
        // Initialize the database
        workoutTemplateRepository.saveAndFlush(workoutTemplate);
        workoutTemplateSearchRepository.save(workoutTemplate);
