...
public class MuscleResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(muscleResource, "muscleSearchRepository", muscleSearchRepository);
        ReflectionTestUtils.setField(muscleResource, "muscleRepository", muscleRepository);
    ...
    public void updateMuscle() throws Exception {
        // Initialize the database
        muscleRepository.saveAndFlush(muscle);
        muscleSearchRepository.save(muscle);
