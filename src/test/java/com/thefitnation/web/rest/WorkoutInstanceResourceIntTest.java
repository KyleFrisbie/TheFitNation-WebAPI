...
public class WorkoutInstanceResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(workoutInstanceResource, "workoutInstanceSearchRepository", workoutInstanceSearchRepository);
        ReflectionTestUtils.setField(workoutInstanceResource, "workoutInstanceRepository", workoutInstanceRepository);
    ...
    public void updateWorkoutInstance() throws Exception {
        // Initialize the database
        workoutInstanceRepository.saveAndFlush(workoutInstance);
        workoutInstanceSearchRepository.save(workoutInstance);
